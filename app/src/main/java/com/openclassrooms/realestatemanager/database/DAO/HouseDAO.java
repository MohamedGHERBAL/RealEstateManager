...
public interface HouseDAO {
    ...
    int updateHouse(String category, String district, int price, boolean isEuro,
                    int area, int numberOfRooms, int numberOfBathrooms, int numberOfBedRooms,
                    int school, int shopping, int publicTransport, int swimmingPool,
                    String description, boolean available,
                    String dateOfEntry, String dateOfSale, String realEstateAgent, long id);
    ...
    LiveData<List<House>> getSearchedHouse(String district,
                                           int miniPrice, int maxiPrice, int miniArea, int maxiArea,
                                           int miniRoom, int maxiRoom, int school, int shopping,
                                           int publicTransport, int swimmingPool);
