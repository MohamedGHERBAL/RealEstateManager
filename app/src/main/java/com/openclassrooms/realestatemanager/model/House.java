...
/**
 * Created by Mohamed GHERBAL (pour OC) on 24/05/2022
 */
...
public class House implements Serializable {
    ...
    public House(String category, String district, boolean b, int price, int area,
                 int numberOfRooms, int numberOfBathrooms, int numberOfBedRooms, int school,
                 int shopping, int publicTransport, int swimmingPool,
                 String description, String picture, boolean available, String dateOfEntry,
                 String dateOfSale, String realEstateAgent) {
    }

    // 19 values (8 Strings, 9 Integers, 2 Booleans)
    // (s, s, b, i, i, i, i, i, i, i, i, i, s, s, s, b, s, s, s)
    public House(String category, String district, boolean isEuro, int price, int area,
                 int numberOfRooms, int numberOfBathrooms, int numberOfBedrooms, int school,
                 int shopping, int publicTransport, int swimmingPool, String description,
                 String illustration, String address, boolean available, String dateOfEntry,
    ...
    public static House[] getAllHouses() {
        return new House[] {
            new House("Test","Test02",true,1,1,1,1,1,1,1,1,1,"Test03","Test04",true, "01/02/2022", "01/02/2022","James Bond")
        };
    }
